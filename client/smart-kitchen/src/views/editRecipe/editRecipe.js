...
class EditRecipe extends Component {
	...
	componentDidMount() {
		axios.get(`http://localhost:5000/api/recipes/${this.props.match.params.id}`).then((response) =>
			this.setState({
		...
		return (
			<div className="edit-recipe">
				...
				<form className="edit-recipe-form" onSubmit={this.onSubmit}>
					...
					<p>Author</p>
					<input onChange={this.changeHandler} name="author" value={this.state.author} />
					<p>Image Link</p>
